...
/**
 *  Δίνονται ως είσοδο 2 πίνακες - ένας για την Alice και ένας για τον Bob -
 *  που περιέχουν 3 βαθμολογίες ι καθένας σε 3 μαθήματα (Μουσική, Μαθηματικά, Φυσική)
...
public class CompareTriplets {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Alixe Points: " + points[0] +
                        ", Bob Points: " + points[1]);
    }
